...
pygame.display.set_caption("Звездный страж")
...
# Картинки
background = pygame.image.load(path.join(img_dir, "fone.png")).convert()
background_rect = background.get_rect()
player_img = pygame.image.load(path.join(img_dir, "playerShip3_blue.png")).convert_alpha()
...
for i in range(9):
    filename = 'boom/regularExplosion0{}.png'.format(i)
